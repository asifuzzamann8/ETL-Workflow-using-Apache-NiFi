...
<ul>
  <li>Hive won’t work without exact version of MySQL JDBC connector</li>
  <li>Mar Reduce merory allocation needs to be changed</li>
  <li>NiFi needs a restart after default password change</li>
  <li>NiFI Hive JDBC connection won’t work without Validation query</li>
  <li>NiFi Java default heap size needs to be increased</li>
  <li>NiFi archive needs to be purged regularly</li>
</ul>  
